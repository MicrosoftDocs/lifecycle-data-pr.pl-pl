...
| --- | --- |
| [SQL Server 2019](/lifecycle/products/sql-server-2019?branch=live)<br> | wtorek, 7 stycznia 2025 r. |
| [Aplikacje usługi Dynamics 365 for Customer Engagement, wersja 9 (z aktualizacją środowiska lokalnego)](/lifecycle/products/dynamics-365-for-customer-engagement-apps-version-9-onpremises-update?branch=live)<br> | wtorek, 14 stycznia 2025 r. |
| [Oprogramowanie Microsoft Host Integration Server 2020](/lifecycle/products/microsoft-host-integration-server-2020?branch=live)<br> | 8 lipca 2025 r. |
